...
public class SharedPreferencesComponent {
    ...
    //GetDataActionLaporan
    public void setActionLaporanIn(String name) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("GetLaporan", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString("sort", name);
        editor.apply();
    }

    public String getActionLaporan() {
        SharedPreferences sharedPreferences = context.getSharedPreferences("GetLaporan", Context.MODE_PRIVATE);
        return sharedPreferences.getString("sort", "");
    }

    public void setActionLaporanOut(){
        SharedPreferences sharedPreferences = context.getSharedPreferences("GetLaporan", Context.MODE_PRIVATE);
    ...
    public void setActionMakananIn(String name) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("GetMakanan", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString("sort", name);
        editor.apply();
    }
